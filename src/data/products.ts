...
export interface ProductCategory {
    id: string;
    name: string;
    models: { [key: string]: ProductModel };
}

export const productsData: { [key: string]: ProductCategory } = {
    'fresh-slicer': {
        id: 'fresh-slicer',
        ...
        models: {
            'TGM': {
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2410/17296480661729648066783_4224472eef999108ade9.jpg'
            },
            'ATT': {
                id: 'ATT',
                displayName: 'ATT',
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2410/17296480491729648049609_f308206ecef8254664ca.jpg'
            },
            'COX': {
                id: 'COX',
                displayName: 'COX',
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2410/17296479671729647967629_1ba3f19041beaf559d58.jpg'
            },
            ...
            'FSK-20R': {
                ...
                thumbnail: 'https://fujee.com/uploaded/product/420/19ff21c11206e269cf2cfffdc392e63e0.png',
                images: ['https://fujee.com/uploaded/product/420/19ff21c11206e269cf2cfffdc392e63e0.png', 'https://fujee.com/uploaded/product/420/19ff21c11206e269cf2cfffdc392e63e1.png', 'https://fujee.com/uploaded/product/420/19ff21c11206e269cf2cfffdc392e63e2.png', 'https://fujee.com/uploaded/product/420/19ff21c11206e269cf2cfffdc392e63e3.png'],
    ...
    'mincer': {
        ...
        models: {
            ...
            'AGF-10': {
                ...
                thumbnail: 'https://fujee.com/uploaded/product/422/3acf31f0f50ccb40c91792106ecbe50a0.png',
                images: ['https://fujee.com/uploaded/product/422/3acf31f0f50ccb40c91792106ecbe50a0.png'],
    ...
    'bone-saw': {
        ...
        models: {
            ...
            'V16': {
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298368611729836861812_ffe02ce1357262b9f5b4.png'
            },
            'HBS-250D': {
                id: 'HBS-250D',
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298360291729836029939_9567c88390e2e626c086.png'
            },
            'HBS-250': {
                id: 'HBS-250',
                displayName: 'HBS-250',
                ...
                features: [],
                specs: { '기계치수': '530 x 460 x 850', '작업대 크기': '420 x 380', '톱날규격': '1650 x 16 x 0.55' },
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298360131729836013807_73b96fe12e371a04eb74.png'
            },
            'BS-S4': {
                id: 'BS-S4',
                displayName: 'BS-S4',
                description: '수입 골절기',
                thumbnail: 'https://fujee.com/uploaded/product/425/e02fd9a8eae0482ce34c4c6fada5f3480.png',
                images: ['https://fujee.com/uploaded/product/425/e02fd9a8eae0482ce34c4c6fada5f3480.png'],
            ...
            'K-16': {
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298358741729835874277_727da5a903f2752a08bb.png'
            }
        }
    },
    'packaging': {
        ...
        models: {
            'NESPA-R3': {
                ...
                images: ['https://fujee.com/uploaded/product/293/185277b994ad348bf48d7b9822b5c9040.jpg'],
                features: ['컴팩트한 사이즈', '간편한 조작', '다양한 식품 포장 가능'],
                specs: { '제품크기': '2815 x 822 x 1970', '몰드크기': '111 x 162 x 60 x 2', '처리능력': '12 packs/min at 2-MOLD' },
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298350681729835068830_d55ab6b5f184ca4157ae.png'
            },
            'NESPA-R4X': {
                id: 'NESPA-R4X',
                ...
                images: ['https://fujee.com/uploaded/product/376/9413a96e6a4a633941468ca1bc569bf70.jpg'],
            ...
            'NESPA-R7': {
                ...
                images: ['https://fujee.com/uploaded/product/294/8a1a8f1d5dee143814a0450386b096c80.jpg'],
                features: ['최고 사양의 대형기', '고속 생산성', '다양한 필름 적용 가능'],
                specs: { '제품크기': '5650 x 1117 x 2141', '몰드크기': '126 x 162 x 65 x 6', '처리능력': '36 packs/min at 6-MOLD' },
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298350301729835030344_6a6bdd5885a68a95c4f7.png'
            },
            'ANES-T2': {
                id: 'ANES-T2',
                ...
                images: ['https://fujee.com/uploaded/product/305/0996e2af48e7c49a0892b7b0abdf9fed0.png'],
                features: ['제품 형태 보존', '신선도 유지', '뛰어난 밀봉성'],
                specs: { '제품크기': '400 x 600 x 450', '트레이크기': 'MAX. 260 x 340 x 50', '처리능력': '24s' }
            },
            'ANES-T3': {
                id: 'ANES-T3',
                ...
                images: ['https://fujee.com/uploaded/product/296/d034db98234c5a7ef8dc510e62faff330.jpg'],
                features: ['T2 모델의 대형 버전', '더 넓은 작업 공간'],
                specs: { '제품크기': '660 x 438 x 552', '챔버크기': '334 x 237 x 59', '처리능력': '3 ~ 4 packs/min' },
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298349671729834967780_8e13831af9aebc6e94d6.png'
            },
            'ANES-R3': {
                id: 'ANES-R3',
                ...
                images: ['https://fujee.com/uploaded/product/295/002249e06a893a6dfac44873a9ad59360.jpg'],
                features: ['제품의 가치를 높이는 스킨 포장', '롤 필름 자동 공급', '높은 생산성'],
                specs: { '제품크기': '1995 x 1150 x 1680', '몰드크기': '328 x 560', '처리능력': '12 packs/min at 3-Chamber' },
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298350031729835003356_f5dadff6efad9c9cc154.png'
            },
            'NVP-S5': {
                id: 'NVP-S5',
                ...
                images: ['https://fujee.com/uploaded/product/82/21b1f933920d21a9d05abfa1cbb525a30.jpg'],
                features: ['안정된 품질로 검증된 제품', '간편한 조작'],
                specs: { '제품크기': '605 x 764 x 979', '챔버크기': '510 x 600 x 186', '씰링크기': '506 x 11' },
                specImage: 'https://fujee.com/uploaded/webedit/2407/17218817281721881728617_d0f12302fe3a82746857.jpg'
            },
            'HFV-400': {
                id: 'HFV-400',
                displayName: 'HFV-400 (진공포장기)',
            ...
            'HFV-500': {
                ...
                specs: { '기계치수': '580 x 690 x 970 mm', '진공실규격': '520 x 540 x 200 mm', '진공펌프': '20 m³/h' },
                specImage: 'https://fujee.com/uploaded/webedit/2410/17298361581729836158344_95584dfc1464290b4830.png'
            },
            'HFV-600': {
                id: 'HFV-600',
                displayName: 'HFV-600 (진공포장기)',
                ...
                features: ['넓은 접착바', '강력한 진공'],
                specs: { '기계치수': '680x790x970mm', '진공실규격': '620x640x200mm', '진공펌프': '20 m³/h' },
                specImage: 'https://fujee.com/uploaded/webedit/2407/17218818041721881804617_2b20f929363a03359d9f.jpg'
            },
            'HFV-700L': {
                id: 'HFV-700L',
                displayName: 'HFV-700L (진공포장기)',
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2407/17218818311721881831617_c8289052b04169736827.jpg'
            },
            'HFV-900L': {
                id: 'HFV-900L',
                displayName: 'HFV-900L (진공포장기)',
                description: '경사형 L형 챔버 진공포장기',
                ...
                specImage: 'https://fujee.com/uploaded/webedit/2407/17218818551721881855617_e72a0f39443657b98583.jpg'
            },
            'HFV-780D': {
                id: 'HFV-780D',
                displayName: 'HFV-780D (진공포장기)',
                ...
                specs: { '기계치수': '1700 x 860 x 970 mm', '진공실규격': '820 x 620 x 240 mm', '진공펌프': '100 m³/h' },
                specImage: 'https://fujee.com/uploaded/webedit/2407/17218818781721881878617_2841578351536b04128f.jpg'
            },
            'HFV-840D': {
                id: 'HFV-840D',
                displayName: 'HFV-840D (진공포장기)',
                ...
                features: ['더블 챔버', '대량 생산'],
                specs: { '기계치수': '1820x860x970mm', '진공실규격': '880x620x240mm', '진공펌프': '100 m³/h' },
                specImage: 'https://fujee.com/uploaded/webedit/2407/17218819001721881900617_3473132e48231c552174.jpg'
            },
            'PA3': {
                id: 'PA3',
                displayName: 'PA3 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/333/95cef232fcea058b7c18ed67a62c16f70.png',
                images: ['https://fujee.com/uploaded/product/333/95cef232fcea058b7c18ed67a62c16f70.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '350x450x550mm' }
            },
            'PA2': {
                id: 'PA2',
                displayName: 'PA2 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/332/d6692cb1ea214718fd46516501500cfb0.png',
                images: ['https://fujee.com/uploaded/product/332/d6692cb1ea214718fd46516501500cfb0.png', 'https://fujee.com/uploaded/product/332/d6692cb1ea214718fd46516501500cfb1.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '300x400x500mm' }
            },
            'PS4': {
                id: 'PS4',
                displayName: 'PS4 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/331/28296360af2a8e7b87b6c2b9227b03ca0.png',
                images: ['https://fujee.com/uploaded/product/331/28296360af2a8e7b87b6c2b9227b03ca0.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '400x500x600mm' }
            },
            'PS3': {
                id: 'PS3',
                displayName: 'PS3 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/330/0007c0df4c705f3b586c540fc04088540.png',
                images: ['https://fujee.com/uploaded/product/330/0007c0df4c705f3b586c540fc04088540.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '350x450x550mm' }
            },
            'PS2': {
                id: 'PS2',
                displayName: 'PS2 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/329/9f9c7eefc45b563e3b45bff04eb964450.png',
                images: ['https://fujee.com/uploaded/product/329/9f9c7eefc45b563e3b45bff04eb964450.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '300x400x500mm' }
            },
            'PS1': {
                id: 'PS1',
                displayName: 'PS1 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/328/9aa66717384304ea58b3f842320f00ef0.png',
                images: ['https://fujee.com/uploaded/product/328/9aa66717384304ea58b3f842320f00ef0.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '250x350x450mm' }
            },
            'M4': {
                id: 'M4',
                displayName: 'M4 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/327/81d68247f9bef26fe52d0fb024a50eb30.png',
                images: ['https://fujee.com/uploaded/product/327/81d68247f9bef26fe52d0fb024a50eb30.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '400x500x600mm' }
            },
            'M3': {
                id: 'M3',
                displayName: 'M3 (실링포장기)',
                description: '실링포장기',
                thumbnail: 'https://fujee.com/uploaded/product/326/228c603b68dd532ea62bad8c788124290.png',
                images: ['https://fujee.com/uploaded/product/326/228c603b68dd532ea62bad8c788124290.png'],
                features: ['실링 포장'],
                specs: { '기계치수': '350x450x550mm' }
            },
            'FILLER-432': {
                ...
                displayName: '충진 포장기',
                description: '충진 포장기',
                thumbnail: 'https://fujee.com/uploaded/product/432/5bafcc8564b4822768b2edffd349b3ee0.png',
                images: ['https://fujee.com/uploaded/product/432/5bafcc8564b4822768b2edffd349b3ee0.png', 'https://fujee.com/uploaded/product/432/5bafcc8564b4822768b2edffd349b3ee1.png'],
                features: ['정량 충진', '위생적인 구조'],
                specs: { '처리능력': '주문 사양' }
            },
            'TW-500': {
                id: 'TW-500',
                displayName: 'TW-500 (랩포장기)',
                description: '랩포장기',
                thumbnail: 'https://fujee.com/uploaded/product/301/8c21069310f64b786457a7cd9f8494d70.png',
                images: ['https://fujee.com/uploaded/product/301/8c21069310f64b786457a7cd9f8494d70.png'],
                features: ['랩 포장', '간편한 사용'],
                specs: { '기계치수': '500mm' }
            },
            'HFW-460': {
                id: 'HFW-460',
                displayName: 'HFW-460 (랩포장기)',
                description: '랩포장기',
                thumbnail: 'https://fujee.com/uploaded/product/300/341c13ac0090fe75efd3a210a2f289500.png',
                images: ['https://fujee.com/uploaded/product/300/341c13ac0090fe75efd3a210a2f289500.png'],
                features: ['랩 포장', '위생적인 구조'],
                specs: { '기계치수': '460mm' }
            }
        }
    },
